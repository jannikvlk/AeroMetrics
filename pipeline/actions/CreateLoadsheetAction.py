...
def extract(message: str) -> str | None:
    ...
    if (
        ...
        if "TRIP FUEL" in message:
            # This identifies zyxw messages because they are the only ones 
            # with TRIP followed by FUEL
            patterns = {
        ...
        elif "ZERO FUEL WEIGHT ACTUAL" in message: 
            # This identifies abcd messages
            ...
            # This identifies mnop messages because they are the only ones 
            # with abbreviations like ZFW
            patterns = {
        ...
        for key, pattern in patterns.items():
            ...
            if match:
                ...
                extracted_weights[key] = None
                # Assign None if the value is not found

        return json.dumps(extracted_weights)

    if ("STATUS LOADSHEET" in message
